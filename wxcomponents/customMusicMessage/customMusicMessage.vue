<template>
<uni-shadow-root class="customMusicMessage-customMusicMessage"><view class="container">
  <view class="answer">
...
global['__wxRoute'] = 'customMusicMessage/customMusicMessage'
Component({
  properties: {
    msg: Object
  },
...
export default global['__wxComponents']['customMusicMessage/customMusicMessage']
</script>
