...
<script>
  ...
  import uvLine from '../../../uv-line/components/uv-line/uv-line.vue';
  import uvGap from '../../../uv-gap/components/uv-gap/uv-gap.vue';
  import uvLoadingIcon from '../../../uv-loading-icon/components/uv-loading-icon/uv-loading-icon.vue';
