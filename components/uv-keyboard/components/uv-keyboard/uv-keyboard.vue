...
<script>
  ...
  import uvKeyboardNumber from '../../../uv-keyboard-number/components/uv-keyboard-number/uv-keyboard-number.vue';
  import uvKeyboardCar from '../../../uv-keyboard-car/components/uv-keyboard-car/uv-keyboard-car.vue';
